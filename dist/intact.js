...
var getParentTemplate = isNative(nativeGetPrototypeOf) ? function (instance) {
...
function processSelect(vNode, dom, nextProps, isRender, mountedQueue) {
...
function processForm(vNode, dom, nextProps, isRender, mountedQueue) {
    var type = vNode.type;
    if (type & Types.InputElement) {
        ...
        processSelect(vNode, dom, nextProps, isRender, mountedQueue);
    }
}
...
function createHtmlElement(vNode, parentDom, mountedQueue, isRender, parentVNode) {
    ...
    if (isFormElement) {
        processForm(vNode, dom, props, true, mountedQueue);
    }
...
function Intact$1(props) {
    ...
    var parentTemplate = getParentTemplate(this);
